<template>
    <div style="background-image: url('/img/historias/5.svg'); background-size: cover; background-position: center right;">
        <div style="height: 400px; position: relative; background-color: rgba(0, 0, 0, .2);" class="p">
