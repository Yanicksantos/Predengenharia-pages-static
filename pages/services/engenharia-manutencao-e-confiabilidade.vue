<template >
    <div >
        <div class="" style="background-image: url('/img/services/1.svg'); height: 350px; background-size: cover; background-position: center center;">
        ...
        <v-main class="pa-0">
            <div>
                ...
                <div class="px-6 pb-4">
                    <v-img src="/img/services/man/1.jpg" class="rounded "></v-img>
                    <div class="text-grey-darken-3 ">
                        ...
                        <p class="text-body-2">O problema ganha dimensões ainda maiores no caso de grandes indústrias que têm como ponto crítico os seus custos de manutenção. Reduzir essas despesas se torna prioridade à medida que os custos de manutenção de ativos representam de 20% a 40% do total de custos operacionais destas empresas alcançando, em todo o mundo, aproximadamente US$ 1 trilhão ao ano. A boa notícia é que esse valor pode (e deve), ser reduzido em cerca de um terço com a adoção de uma boa gestão dos ativos operacionais, que parte de uma implantação racional do sistema/módulo de gestão da manutenção.</p>
                    </div>
                </div>
                <div class="px-4 py-4 bg-grey-lighten-2 h-100" >
                    <div class=" pa-2">
                        <h4 class="text-body-2 pa-2">Com a experiência de 20 anos nesta área, a Pred Engenharia apoia consultivamente no desenvolvimento e/ou na implementação de projetos envolvendo:</h4>
                        <div class="bg-grey-lighten-3 mt-2 py-2 rounded">
                            <v-list-item prepend-icon="mdi-cog-play" class="text-caption mb-2">
                            ...
                            <v-list-item prepend-icon="mdi-cog-play" class="text-caption">
                        ...
                        <div class="text-caption pa-2">Caso a sua necessidade seja apoio na migração de ERP ou troca de versão do mesmo, a Pred Engenharia fornece o serviço de preparação dos dados mestres do legado para uma nova versão e/ou estrutura de dados.</div>
                    </div>
                ...
                <div class="bg-white px-6" >
                    <div class=" py-4">
                        ...
                        style="width: 100%; height: 1px; background-image: linear-gradient(to left, transparent, transparent,#1A237E);" 
                        class="mb-4 mt-2"></div>
                        <p class="text-grey-darken-3 text-caption text-medium-emphasis font-weight-light">Pelo menos 50% das falhas em rolamentos e 60% dos problemas em redutores de engrenagens estão associadas à lubrificação.</p>
                    </div>
                    <div >
                        <p class="text-body-2 mb-2">A Pred Engenharia disponibiliza cinco serviços de engenharia essenciais à otimização técnica, gerencial e financeira dos seus processos de lubrificação de equipamentos. São eles:</p>
                        <v-img src="/img/services/man/2.jpg" class="rounded "></v-img>
                    </div>
                </div>

                  <!--outra secção-->

                  <div class="bg-indigo-darken-4 px-6 py-2" >
                    <div class=" py-2" >
                        <div class=" mt-4 mb-2 ml-2  text-h4 font-weight-bold text-white" style="color: #BDBDBD;">
                    ...
                    <div >
                        <v-img src="/img/services/man/3.jpg" class="rounded-shaped "></v-img>
                        <div>
                            <p class="text-body-2 mt-4">É muito comum encontrar planos de manutenção que são cópias exatas dos manuais dos equipamentos. Esta prática é típica de planejamentos feitos dentro de sala, ou seja, sem levantamento em campo das peculiaridades das instalações. Quando isso ocorre, acredite, as execuções destes planos provavelmente estão sendo feitas dentro da oficina/escritório. Isso é denominado pela Pred Engenharia como Gestão do Autoengano, ou seja, alguém fez de conta que planejou e as equipes envolvidas estão fazendo de conta que executam.</p>
                            <p class="text-body-2 my-2">A Pred Engenharia acredita que um bom plano de manutenção é aquele que é “cumprível”. Para tanto, precisa ser feito em campo e por profissionais experientes, seguindo procedimentos/diretrizes formalmente definidos no <a href="#" class="text-decoration-none">diagnóstico da manutenção</a>, sobre as quatro linhas de planejamento acima ilustrado.</p>
                        </div>
                ...
                <div  class="bg-indigo-darken-3 px-6 py-2">
                    <div class=" py-2" >
                        <div class=" mt-4 mb-2 ml-2  text-h4 font-weight-bold text-white" style="color: #BDBDBD;">
                    ...
                    <div >
                        <v-img src="/img/services/man/4.png" class="rounded-shaped "></v-img>
                        <p class="text-body-2 mt-4">A metodologia Pred Engenharia para a elaboração do diagnóstico da manutenção lhe permite cruzar informações de cinco fontes, e assim obter indicadores que determinarão as medidas necessárias para otimizar os resultados de sua manutenção.</p>
                    </div>
                </div>
                ...
                <div class="px-4 py-4 bg-grey-lighten-2 h-100" >
                        <div class=" pa-2">
                            ...
                            style="width: 100%; height: 1px; background-image: linear-gradient(to left, transparent, transparent,#1A237E);" 
                            class="mb-4 mt-2"></div>
                            <p class="text-grey-darken-3 text-body-2">A Pred Engenharia disponibiliza treinamentos abertos ou fechados às suas reais necessidades, sempre acompanhados de medição de eficiência e eficácia.</p>
                        </div>

                        
                        <div class="bg-grey-lighten-3 mt-2 py-2 rounded">
                            <p class="text-body-2 py-2 px-4">A Pred Engenharia é especialista em treinamentos de alto valor agregado. Através da FLIR, disponibiliza os Treinamentos nível 1 e 2 do ITC (Infrared Training Center), em ambientes abertos e também in company. Promove também treinamentos fechados, customizados e voltados à engenharia de aplicação de técnicas e práticas de planejamento e controle da manutenção/inspeção. São eles:</p>
                            <v-list-item prepend-icon="mdi-cog-play" class="text-caption mb-2">
                ...
                <div class="bg-grey-lighten-3 px-6 py-4" >
                    <div class=" py-4">
                    ...
                    <div >
                        <v-img src="/img/services/man/5.jpg" class="rounded "></v-img>
                        <p class="text-body-2 mb-2">O grande desafio dos gestores da manutenção é garantir que, os processos de análise crítica sobre as rotinas da manutenção, estejam acontecendo e que os resultados destes estejam sendo usados na otimização do plano de manutenção.</p>
                        <p class="text-body-2 mb-2">Com um programa regular de auditorias você terá como detectar a descontinuidade destes processos e tomar medidas para a regularização, antes que os mesmos reflitam na sua taxa de falhas/interrupções e/ou nos custos da manutenção.</p>
                    </div>
                </div>
