        ...
        <v-main class="pa-0">
            <div>
                <v-container>
                    ...
                    <div class="px-6 pb-4">
                        <v-img src="/img/services/man/1.jpg" class="rounded my-6" max-width="800"></v-img>
                ...
                <div class="bg-white px-6" >
                    <v-container>
                        ...
                        <div >
                            ...
                            <v-img src="/img/services/man/2.jpg" class="rounded mx-auto my-4" max-width="700"></v-img>
                        </div>
                    </v-container>
                </div>
                  ...
                  <div class="bg-indigo-darken-4 px-6 py-2" >
                    <v-container>
                        ...
                        <div >
                            <v-img src="/img/services/man/3.jpg" class="rounded-shaped my-6" max-width="700"></v-img>
                            <div>
                ...
                <div  class="bg-indigo-darken-3 px-6 py-2">
                    <v-container>
                        ...
                        <div >
                            <v-img src="/img/services/man/4.png" class="rounded-shaped my-6" max-width="700"></v-img>
                ...
                <div class="bg-grey-lighten-3 px-6 py-4" >
                    <v-container>
                        ...
                        <div >
                            <v-img src="/img/services/man/5.jpg" class="rounded my-6" max-width="700"></v-img>
